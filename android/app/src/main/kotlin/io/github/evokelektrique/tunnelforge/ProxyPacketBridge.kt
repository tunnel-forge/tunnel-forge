 ...
 *
 * Direction names are from the native PPP bridge perspective: outbound packets are generated by
 * gVisor and queued toward PPP/L2TP, while inbound packets are read from PPP/L2TP and injected
 * into gVisor. This wrapper keeps those JNI calls out of listener and transport code.
 */
